...
func (orh *OrderHandler) CreateOrderHandler(rw http.ResponseWriter, r *http.Request) {
	...
	var newOrder models.ServiceOrder
	...
	request := models.Request{
		...
		NotificationURL:    "https://b9c9-181-16-122-17.ngrok-free.app/order/webhook",
		Expires:            true,
...
func (orh *OrderHandler) WebHook(rw http.ResponseWriter, r *http.Request) {
	...
	layout := "2006-01-02" // formato que se debe usar
	...
	newOrder, err := orh.ord_srv.CreateNewOrder(orh.ctx, &models.Order{
		...
		Schedule_day_date:   &parsedDate, // payment.Metadata.Schedule_day_date
...
func (orh *OrderHandler) Refound(rw http.ResponseWriter, r *http.Request) {
	...
	var refund models.RefundResponse
