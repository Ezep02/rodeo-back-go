...
func NewGormInfoRepo(db *gorm.DB, redis *redis.Client) information.InformationRepository {
	return &GormInfoRepository{db, redis}
}

func (r *GormInfoRepository) BarberInformation(ctx context.Context) (*information.BarberInformation, error) {

	var (
		info             *information.BarberInformation
